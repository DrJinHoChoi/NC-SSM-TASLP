...
\pgfplotsset{
  noise plot/.style={
    width=0.34\textwidth, height=3.0cm,
...
\begin{axis}[noise plot, name=p2, at={(p1.east)}, anchor=west, xshift=0.2cm,
...
\begin{axis}[noise plot, name=p3, at={(p2.east)}, anchor=west, xshift=0.2cm,
    title={Babble}, ylabel={}, xlabel={},
    legend style={at={(1.0,0.02)}, anchor=south east, font=\scriptsize,
      row sep=-2pt, legend columns=1}]
\addplot[color=red!70!black, mark=square*]
...
\legend{BC-ResNet-1 (7.5K\,/\,4.70M), NC-SSM (7.4K\,/\,0.85M), NC-SSM-L (10.2K\,/\,1.15M)}
\end{axis}
...
\begin{axis}[noise plot, name=p5, at={(p4.east)}, anchor=west, xshift=0.2cm,
