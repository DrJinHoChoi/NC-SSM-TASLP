...
NanoMamba requires only +10.6\,\%p from noise-aug; BC-ResNet-1 needs +20.7\,\%p (2.0$\times$) and DS-CNN-S needs +38.8\,\%p (3.7$\times$).
...
\begin{remark}[SF bridge limitations]
Spectral flatness measures spectral \emph{shape} rather than energy level, limiting its ability to distinguish different SNR levels of the same noise type (e.g., white noise at $-15$\,dB vs.\ $-5$\,dB).
An alternative bridge using the average spectral subtraction gain---which monotonically relates to input SNR---is a natural improvement direction (Section~\ref{sec:limitations}).
\end{remark}
...
\multirow{6}{*}{Factory}
  ...
  & BC-ResNet-1 (7.5K)     & 95.0 & \textbf{63.2} & \textbf{71.7} & \textbf{81.5} & \textbf{88.0} & \textbf{90.7} & 92.0 & \textbf{93.3} \\
  & NM-Matched (7.4K)      & 95.1 & 61.1 & 70.6 & 82.3 & 88.5 & 91.4 & 93.0 & 93.8 \\
  & NC-SSM (7.5K)          & 95.3 & 61.4 & 69.2 & 77.8 & 86.8 & 90.1 & 92.4 & 92.9 \\
  & NC-SSM-Large (10.2K)   & \textbf{95.6} & 61.3 & 68.6 & 79.1 & 87.0 & 91.0 & \textbf{93.1} & 93.4 \\
  & NC-SSM-L+NASG (10.2K)  & --- & --- & --- & --- & --- & --- & --- & --- \\
\midrule
\multirow{6}{*}{White}
  & DS-CNN-S (23.8K)       & 96.8 & 61.7 & 67.1 & 81.6 & 89.9 & 93.1 & 94.8 & 95.6 \\
  & BC-ResNet-1 (7.5K)     & 95.0 & \textbf{54.4} & \textbf{60.6} & \textbf{73.7} & 83.0 & 89.4 & 91.7 & 93.6 \\
  & NM-Matched (7.4K)      & 95.1 & 31.1 & 59.1 & 75.0 & 85.5 & 89.8 & 92.8 & 93.9 \\
  & NC-SSM (7.5K)          & 95.3 & 50.8 & 63.0 & 75.5 & 85.2 & 90.0 & 92.5 & 93.5 \\
  & NC-SSM-Large (10.2K)   & \textbf{95.6} & 34.1 & 59.8 & 76.5 & \textbf{86.4} & \textbf{91.0} & \textbf{93.4} & \textbf{94.4} \\
  & NC-SSM-L+NASG (10.2K)  & --- & --- & --- & --- & --- & --- & --- & --- \\
\midrule
\multirow{6}{*}{Babble}
  & DS-CNN-S (23.8K)       & 96.8 & 79.2 & 86.2 & 91.4 & 94.5 & 95.5 & 95.9 & 96.5 \\
  & BC-ResNet-1 (7.5K)     & 95.0 & \textbf{72.0} & \textbf{81.1} & \textbf{86.7} & \textbf{91.2} & \textbf{93.0} & \textbf{94.2} & 94.5 \\
  & NM-Matched (7.4K)      & 95.1 & 71.4 & 79.0 & 86.0 & 91.0 & 93.0 & 93.9 & 94.5 \\
  & NC-SSM (7.5K)          & 95.2 & 73.4 & 79.1 & 84.1 & 89.9 & 92.4 & 94.0 & 94.8 \\
  & NC-SSM-Large (10.2K)   & \textbf{95.5} & 74.0 & 80.2 & 86.8 & 91.3 & 93.3 & \textbf{94.4} & \textbf{95.1} \\
  & NC-SSM-L+NASG (10.2K)  & --- & --- & --- & --- & --- & --- & --- & --- \\
\midrule
\multirow{6}{*}{Street}
  & DS-CNN-S (23.8K)       & 96.8 & 61.1 & 69.4 & 81.5 & 88.9 & 92.8 & 95.0 & 95.9 \\
  & BC-ResNet-1 (7.5K)     & 95.0 & \textbf{60.5} & \textbf{63.3} & 73.3 & \textbf{83.2} & 87.9 & 92.1 & 93.4 \\
  & NM-Matched (7.4K)      & 95.1 & 57.6 & 64.2 & 73.9 & 83.8 & 88.4 & 92.4 & 94.2 \\
  & NC-SSM (7.5K)          & 95.2 & 60.2 & 64.3 & 75.2 & 82.2 & 88.9 & 92.2 & 93.7 \\
  & NC-SSM-Large (10.2K)   & \textbf{95.6} & 57.8 & 63.5 & 75.7 & 83.4 & \textbf{90.1} & 92.8 & \textbf{94.5} \\
  & NC-SSM-L+NASG (10.2K)  & --- & --- & --- & --- & --- & --- & --- & --- \\
\midrule
\multirow{6}{*}{Pink}
  & DS-CNN-S (23.8K)       & 96.8 & 61.2 & 66.4 & 82.7 & 90.6 & 93.8 & 95.1 & 95.9 \\
  & BC-ResNet-1 (7.5K)     & 95.0 & \textbf{54.9} & 61.9 & 75.8 & 85.6 & 90.8 & \textbf{93.3} & 94.2 \\
...
\midrule
NM-Matched  & \textbf{+3.6} & \textbf{+23.8} & $-$0.1 & +1.7 & \textbf{+29.2} \\
NC-SSM      & +0.7 & +15.4 & \textbf{+0.4} & +1.4 & +4.1 \\
...
BC-ResNet-1  & 7.0 & 12.0 & 3.8 & 11.8 & 9.4 \\
NM-Matched   & 6.6 & 9.6 & 4.1 & 11.3 & 7.9 \\
NC-SSM       & 8.5 & 10.1 & 5.3 & 13.0 & 8.6 \\
NC-SSM-Large & 8.6 & 9.2 & 4.2 & 12.2 & 8.4 \\
\bottomrule
\end{tabular}
\end{table}
...
\smallskip\noindent\textbf{NASG behavior analysis.}
Table~\ref{tab:nasg_behavior} compares effective selectivity with and without NASG across SNR levels.
At clean SNR, NASG is transparent ($g \approx 0.993$); at $-15$\,dB, the combined $\sigma \cdot g \approx 0.001$ suppresses cross-term noise by $\sim$2{,}500$\times$---formally achieving the $O(\sigma_n^2)$ bound of Proposition~\ref{prop:nasg}.

\begin{table}[h]
\centering
\caption{Effective selectivity: $\sigma$-gate alone vs.\ $\sigma \cdot g$ with NASG.}
\label{tab:nasg_behavior}
\begin{tabular}{lccc}
\toprule
SNR & $\sigma$ (gate only) & $g$ (NASG) & $\sigma \cdot g$ \\
\midrule
Clean & 0.97 & 0.993 & 0.963 \\
$-5$\,dB & 0.15 & 0.3--0.5 & 0.04--0.08 \\
$-15$\,dB & 0.05 & 0.015 & $\approx$0.001 \\
\bottomrule
\end{tabular}
\end{table}

\smallskip\noindent\textbf{State masking behavior.}
Adaptive state masking (Section~\ref{sec:state_mask}) further reduces noise by restricting the effective state dimensionality.
At $-15$\,dB, the effective state dimension reduces to $N_{\text{eff}} \approx 0.2\text{--}0.3$ (from $N{=}8$), and the state norm $\|\mathbf{h}_{t,n}\| \approx 0$ for masked states.
The input-gating design is critical: output-gating would allow noise to accumulate freely across $T$ frames before discarding the corrupted state; input-gating prevents noise \emph{entry} entirely.
...
\textbf{Model} & \textbf{Params} & \textbf{MACs} & \textbf{Lat.} & \textbf{Energy} & \textbf{RAM} \\
               &                & (M)          & (ms)         & ($\mu$J)       & (KB)        \\
\midrule
NC-SSM         & 7{,}453  & \textbf{0.85} & \textbf{1.8}  & \textbf{354}   & \textbf{31.7}  \\
...
NC-SSM achieves \textbf{5.5$\times$ fewer MACs}, \textbf{5.4$\times$ lower latency}, and \textbf{5.5$\times$ less energy} than BC-ResNet-1 at matched parameters (7{,}453 vs.\ 7{,}464).
