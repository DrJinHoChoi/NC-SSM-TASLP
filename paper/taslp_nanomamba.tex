...
\begin{table*}[t]
\centering
\caption{Noise robustness comparison (accuracy \%). All models trained with noise augmentation. Best per condition in \textbf{bold} (excluding the $3.2\times$ larger DS-CNN-S).}
...
\multirow{8}{*}{Factory}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 60.7 & 68.9 & 80.7 & \textbf{89.3} & \textbf{92.6} & \textbf{94.0} & \textbf{94.6} \\
...
\multirow{8}{*}{White}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 40.4 & 59.8 & \textbf{79.2} & \textbf{87.5} & \textbf{91.6} & \textbf{93.6} & \textbf{94.7} \\
