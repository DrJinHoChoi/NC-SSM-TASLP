...
\begin{tikzpicture}[
  ...
  >=Stealth,
  block/.style={rectangle, draw, rounded corners=3pt, minimum height=1.1cm, minimum width=1.6cm, font=\small\sffamily\bfseries, align=center, very thick},
...
This frequency-selective behavior---impossible with SM-SSM's scalar gate---enables NC-SSM to maintain competitive clean accuracy while improving noise robustness.
