...
\pgfplotsset{
  low snr plot/.style={
    width=0.35\textwidth, height=4.8cm,
    ...
    every axis plot/.append style={semithick, mark size=2.0pt},
...
\begin{axis}[low snr plot, name=p2, at={(p1.east)}, anchor=west, xshift=0.15cm,
...
\begin{axis}[low snr plot, name=p3, at={(p2.east)}, anchor=west, xshift=0.15cm,
...
\begin{axis}[low snr plot, name=p5, at={(p4.east)}, anchor=west, xshift=0.15cm,
...
\begin{axis}[high snr plot, name=q2, at={(q1.east)}, anchor=west, xshift=0.15cm,
    title={White}, ylabel={}, xlabel={}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.3}]
...
\begin{axis}[high snr plot, name=q3, at={(q2.east)}, anchor=west, xshift=0.15cm,
    title={Babble}, ylabel={}, xlabel={}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.3}]
...
\begin{axis}[high snr plot, name=q5, at={(q4.east)}, anchor=west, xshift=0.15cm,
    title={Pink}, ylabel={}, xlabel={SNR (dB)}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.3}]
