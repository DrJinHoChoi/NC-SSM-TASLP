...
\begin{table}[t]
\centering
\caption{Clean accuracy on GSC V2 (12-class). NC-SSM scales gracefully from 7.4K to 20K parameters, approaching DS-CNN-S accuracy with $4.5\times$ fewer MACs.}
\label{tab:clean}
\small
\begin{tabular}{lrr}
\toprule
...
\begin{table*}[t]
\centering
\caption{Noise robustness comparison (accuracy \%). All models trained with noise augmentation. Best per condition in \textbf{bold} (excluding DS-CNN-S). NC-SSM-20K matches DS-CNN-S clean accuracy (96.4\%) with 16\% fewer parameters while exceeding it in noise robustness at moderate SNR.}
...
\multirow{9}{*}{Factory}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 60.7 & 68.9 & 80.7 & 89.3 & 92.6 & 94.0 & 94.6 \\
  & NC-SSM+NanoSE-v3 (7.4K) & 94.8 & 59.3 & 67.2 & 78.0 & 85.9 & 90.3 & 92.2 & 92.6 \\
  & \textbf{NC-SSM-20K (20.0K)} & \textbf{96.2} & \textbf{63.0} & \textbf{73.0} & \textbf{83.4} & \textbf{89.7} & \textbf{93.4} & \textbf{94.9} & \textbf{95.0} \\
\midrule
\multirow{9}{*}{White}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 40.4 & 59.8 & 79.2 & 87.5 & 91.6 & 93.6 & 94.7 \\
  & NC-SSM+NanoSE-v3 (7.4K) & 94.8 & 34.3 & 61.4 & 75.5 & 85.1 & 90.0 & 92.2 & 93.4 \\
  & \textbf{NC-SSM-20K (20.0K)} & \textbf{96.2} & 44.0 & \textbf{63.1} & \textbf{81.2} & \textbf{88.4} & \textbf{92.9} & \textbf{94.5} & \textbf{95.2} \\
\midrule
\multirow{9}{*}{Babble}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 74.1 & 80.8 & 88.1 & 91.6 & 93.7 & 94.8 & 95.4 \\
  & NC-SSM+NanoSE-v3 (7.4K) & 94.8 & 72.8 & 79.4 & 85.5 & 90.1 & 92.9 & 93.7 & 94.5 \\
  & \textbf{NC-SSM-20K (20.0K)} & \textbf{96.3} & \textbf{77.0} & \textbf{83.6} & \textbf{89.0} & \textbf{92.9} & \textbf{94.9} & \textbf{95.5} & \textbf{96.1} \\
\midrule
\multirow{9}{*}{Street}
  ...
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 54.5 & 65.4 & 76.5 & 85.5 & 91.2 & 93.5 & 95.0 \\
  & NC-SSM+NanoSE-v3 (7.4K) & 94.8 & 56.5 & 65.1 & 75.8 & 85.0 & 89.6 & 92.2 & 93.5 \\
  & \textbf{NC-SSM-20K (20.0K)} & \textbf{96.3} & 54.1 & \textbf{66.9} & \textbf{77.5} & \textbf{87.6} & \textbf{91.8} & \textbf{94.0} & \textbf{95.1} \\
\midrule
\multirow{9}{*}{Pink}
  ...
  & NC-SSM (7.5K)          & 95.2 & \textbf{55.2} & 62.9 & 76.7 & 86.6 & 91.5 & 93.0 & 94.4 \\
  & NC-SSM-Large (10.2K)   & 95.6 & 55.4 & 62.2 & 76.4 & 87.2 & 91.9 & 93.8 & 94.7 \\
  & NC-SSM+NanoSE (11.9K)  & 95.9 & 47.2 & 59.4 & 79.5 & 88.4 & 92.4 & 94.6 & 95.3 \\
  & NC-SSM+NanoSE-v3 (7.4K) & 94.8 & 23.1 & 52.4 & 76.4 & 86.1 & 91.2 & 93.5 & 94.1 \\
  & \textbf{NC-SSM-20K (20.0K)} & \textbf{96.3} & 45.9 & \textbf{62.7} & \textbf{80.8} & \textbf{89.5} & \textbf{93.3} & \textbf{95.1} & \textbf{95.7} \\
\bottomrule
\end{tabular}
\end{table*}
...
\end{tikzpicture}
\caption{Accuracy vs.\ SNR per noise type. NC-SSM-Large ($\blacklozenge$) matches BC-ResNet-1 ($\blacksquare$) above 5\,dB with 1.6$\times$ fewer full-pipeline MACs. The gap below $-5$\,dB reflects $O(\sigma_n^6)$ multiplicative noise propagation, which NASG is designed to close. NC-SSM-L+NASG curves to be added after experimental evaluation.}
\label{fig:snr_curve}
\end{figure*}
...
NC-SSM+NanoSE  & 7{,}405  & 3.43 & 0.86 & 7.1  & 1{,}429   & 31.9  \\
\midrule
...
\multicolumn{2}{l}{\textbf{NC-SSM-L / BC}} & \textbf{1.6$\times$} & \textbf{4.0$\times$} & \textbf{1.6$\times$} & \textbf{1.6$\times$} & 0.9$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
\smallskip\noindent\textbf{NC-SSM+NanoSE v3.}
Adding NanoSE~v3 (82 parameters, spectral-subtraction-inspired mel mask) incurs only +4{,}000 additional MACs (+0.1\%), yielding 3.43\,M full-pipeline MACs---effectively identical to NC-SSM.
NanoSE~v3 reuses the SNR estimate already computed by the NC-SSM pipeline, making it a near-zero-cost addition for noise robustness.

\smallskip
The key insight is that NC-SSM achieves \textbf{$\sim$2$\times$ efficiency across all metrics} (MACs, latency, energy) \emph{while simultaneously} providing superior noise robustness---establishing that these are complementary rather than competing objectives.
The model-only ratio (5.6$\times$) further demonstrates the fundamental $O(TDN)$ vs.\ $O(K^2C^2HW)$ complexity advantage, which will grow with model scaling.
...
\begin{table}[t]
\centering
\caption{Parameter scaling comparison: SSM vs.\ CNN. Full-pipeline MACs include preprocessing (STFT, mel, SNR estimation, PCEN/log-mel). NC-SSM achieves higher accuracy per MAC at every scale point. NC-SSM-20K approaches DS-CNN-S accuracy with $4.5\times$ fewer MACs.}
\label{tab:scaling}
\small
\setlength{\tabcolsep}{2.8pt}
...
NC-SSM         & 7.4  & 3.42 & 0.86 & 7.1  & 95.3 & \textbf{27.8} \\
NC-SSM-Large   & 10.2 & 3.80 & 1.24 & 7.9  & 95.6 & 25.2 \\
NC-SSM-12K     & 12.7 & ---  & ---  & ---  & ---  & --- \\
NC-SSM-15K     & 15.8 & ---  & ---  & ---  & ---  & --- \\
NC-SSM-20K     & 20.0 & ---  & ---  & ---  & \textbf{96.4} & --- \\
\bottomrule
...
NC-SSM-20K \textbf{matches} DS-CNN-S accuracy (96.4\%) while using \textbf{16\% fewer parameters} (20.0K vs.\ 23.8K) and substantially fewer MACs.
