...
\node[ssm, minimum width=2.4cm, minimum height=0.7cm] at ([yshift=0.3cm]blk1box.center) (scan1) {Selective Scan\\{\tiny $d{=}16,\,N{=}6$}};
...
\node[ssm, minimum width=2.4cm, minimum height=0.7cm] at ([yshift=0.3cm]blk2box.center) (scan2) {Selective Scan\\{\tiny $d{=}16,\,N{=}6$}};
...
NC-SSM+NanoSE-v3 & SSM+SE & 7{,}405 & 7.2\,KB \\
...
\pgfplotsset{
  noise plot/.style={
    width=0.33\textwidth, height=4.5cm,
    xmin=-17, xmax=17, ymin=50, ymax=100,
    xtick={-15,-10,-5,0,5,10,15},
    ytick={50,60,70,80,90,100},
    grid=both,
    grid style={line width=.1pt, draw=gray!10},
    major grid style={line width=.2pt, draw=gray!25},
    every axis plot/.append style={thin, mark size=1.3pt},
...
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.2}]
    coordinates {(-15,63.8)(-10,70.4)(-5,79.9)(0,90.4)(5,93.5)(10,94.9)(15,95.7)};
...
\addplot[color=plot15k, densely dotted, mark=triangle*, mark options={solid}]
    coordinates {(-15,63.2)(-10,73.4)(-5,83.7)(0,89.6)(5,92.6)(10,94.1)(15,94.7)};
\addplot[color=plot20k, mark=pentagon*, mark options={solid}]
    coordinates {(-15,63.0)(-10,73.0)(-5,83.4)(0,89.7)(5,93.4)(10,94.9)(15,95.0)};
\end{axis}

\begin{axis}[noise plot, name=p2, at={(p1.east)}, anchor=west, xshift=0.15cm,
    title={White}, ylabel={}, xlabel={}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.2}]
    coordinates {(-15,61.6)(-10,64.0)(-5,76.8)(0,88.8)(5,92.6)(10,94.3)(15,95.6)};
\addplot[color=plotcnn, mark=square*]
...
\addplot[color=plot15k, densely dotted, mark=triangle*, mark options={solid}]
    coordinates {(-15,44.7)(-10,65.2)(-5,80.0)(0,87.5)(5,92.5)(10,94.2)(15,94.9)};
\addplot[color=plot20k, mark=pentagon*, mark options={solid}]
    coordinates {(-15,44.0)(-10,63.1)(-5,81.2)(0,88.4)(5,92.9)(10,94.5)(15,95.2)};
\end{axis}

\begin{axis}[noise plot, name=p3, at={(p2.east)}, anchor=west, xshift=0.15cm,
    title={Babble}, ylabel={}, xlabel={}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.2}]
    coordinates {(-15,72.8)(-10,80.5)(-5,87.1)(0,91.6)(5,94.8)(10,95.8)(15,96.0)};
\addplot[color=plotcnn, mark=square*]
...
\addplot[color=plot15k, densely dotted, mark=triangle*, mark options={solid}]
    coordinates {(-15,79.2)(-10,84.5)(-5,89.5)(0,92.3)(5,94.5)(10,95.3)(15,95.7)};
\addplot[color=plot20k, mark=pentagon*, mark options={solid}]
    coordinates {(-15,77.0)(-10,83.6)(-5,89.0)(0,92.9)(5,94.9)(10,95.5)(15,96.1)};
\end{axis}
...
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.2}]
    coordinates {(-15,61.5)(-10,67.1)(-5,78.1)(0,88.1)(5,92.5)(10,94.9)(15,95.8)};
\addplot[color=plotcnn, mark=square*]
...
\addplot[color=plot15k, densely dotted, mark=triangle*, mark options={solid}]
    coordinates {(-15,53.9)(-10,67.3)(-5,77.3)(0,86.8)(5,91.1)(10,93.9)(15,94.9)};
\addplot[color=plot20k, mark=pentagon*, mark options={solid}]
    coordinates {(-15,54.1)(-10,66.9)(-5,77.5)(0,87.6)(5,91.8)(10,94.0)(15,95.1)};
\end{axis}
...
\begin{axis}[noise plot, name=p5, at={(p4.east)}, anchor=west, xshift=0.15cm,
    ...
    legend style={font=\tiny, legend columns=3, column sep=3pt,
      draw=none}]
\addplot[color=plotdscnn, dashdotted, mark=|, mark options={solid, scale=1.2}]
    coordinates {(-15,61.3)(-10,62.7)(-5,76.2)(0,88.3)(5,93.1)(10,95.1)(15,96.0)};
...
\addlegendentry{NC-SSM (7.4K)}
\addplot[color=plotlarge, densely dashed, mark=diamond*, mark options={solid}]
    coordinates {(-15,55.4)(-10,62.2)(-5,76.4)(0,87.2)(5,91.9)(10,93.8)(15,94.7)};
\addlegendentry{NC-SSM-L (10.2K)}
\addplot[color=plot15k, densely dotted, mark=triangle*, mark options={solid}]
    coordinates {(-15,46.7)(-10,64.8)(-5,81.3)(0,89.0)(5,93.2)(10,94.8)(15,95.2)};
\addlegendentry{NC-SSM-15K (15.8K)}
\addplot[color=plot20k, mark=pentagon*, mark options={solid}]
    coordinates {(-15,45.9)(-10,62.7)(-5,80.8)(0,89.5)(5,93.3)(10,95.1)(15,95.7)};
...
\end{tikzpicture}
\caption{Accuracy vs.\ SNR across five noise types for the NC-SSM scaling family. Scaling improves clean and moderate-noise accuracy, but at extreme low SNR ($-15$\,dB), larger models (NC-SSM-20K, NC-SSM-15K) degrade below NC-SSM base due to $O(\sigma_n^6)$ multiplicative noise coupling---the \emph{scaling paradox} that motivates the SS front-end.}
\label{fig:snr_curve}
\end{figure*}
...
\begin{table}[t]
\centering
\caption{NC-SSM conditioning ablation. $\Delta$P: additional parameters vs.\ base model. NC-SSM conditioning (+26 params) improves White $-15$\,dB from 31.1\% to 50.8\% (+19.7\,\%p).}
\label{tab:ablation}
\small
\setlength{\tabcolsep}{3pt}
\begin{tabular}{lrccc}
