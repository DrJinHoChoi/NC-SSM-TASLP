...
\end{tikzpicture}
\caption{Accuracy vs.\ SNR per noise type. NC-SSM-Large ($\blacklozenge$) matches BC-ResNet-1 ($\blacksquare$) above 5\,dB with 1.6$\times$ fewer full-pipeline MACs. The gap below $-5$\,dB reflects $O(\sigma_n^6)$ multiplicative noise propagation, which the selectivity modulation mechanism is designed to reduce.}
\label{fig:snr_curve}
\end{figure*}
