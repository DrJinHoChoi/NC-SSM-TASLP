...
\begin{table}[t]
\centering
\caption{Clean accuracy on GSC V2 (12-class). NC-SSM scales gracefully from 7.4K to 20K parameters, matching DS-CNN-S accuracy with $5.1\times$ fewer MACs.}
\label{tab:clean}
\small
\begin{tabular}{lrr}
\toprule
...
\begin{table*}[t]
\centering
\caption{Noise robustness comparison (accuracy \%). All models trained with noise augmentation. Best per condition in \textbf{bold}. NC-SSM-20K matches DS-CNN-S clean accuracy (96.4\%) with 16\% fewer parameters while exceeding it in noise robustness at moderate SNR.}
...
\multirow{9}{*}{Factory}
  ...
  & NC-SSM-20K (20.0K) & 96.2 & 63.0 & \textbf{73.0} & \textbf{83.4} & 89.7 & 93.4 & \textbf{94.9} & 95.0 \\
\midrule
\multirow{9}{*}{White}
  & DS-CNN-S (23.8K)       & \textbf{96.4} & \textbf{61.6} & \textbf{64.0} & 76.8 & \textbf{88.8} & 92.6 & 94.3 & \textbf{95.6} \\
...
\multirow{9}{*}{Babble}
  ...
  & NC-SSM-20K (20.0K) & 96.3 & \textbf{77.0} & \textbf{83.6} & \textbf{89.0} & \textbf{92.9} & \textbf{94.9} & 95.5 & \textbf{96.1} \\
\midrule
\multirow{9}{*}{Street}
  & DS-CNN-S (23.8K)       & \textbf{96.4} & \textbf{61.5} & \textbf{67.1} & \textbf{78.1} & \textbf{88.1} & \textbf{92.5} & \textbf{94.9} & \textbf{95.8} \\
...
\multirow{9}{*}{Pink}
  ...
  & NC-SSM-20K (20.0K) & 96.3 & 45.9 & 62.7 & \textbf{80.8} & \textbf{89.5} & \textbf{93.3} & \textbf{95.1} & 95.7 \\
\bottomrule
\end{tabular}
\end{table*}
...
NC-SSM-12K     & 12.7 & 4.08 & 1.52 & 8.5  & ---  & --- \\
NC-SSM-15K     & 15.8 & 4.48 & 1.92 & 9.3  & ---  & --- \\
