...
\pgfplotsset{
  noise plot/.style={
    ...
    every axis plot/.append style={semithick, mark size=1.2pt},
...
\addplot[color=blue!80!black, mark=*]
    coordinates {(-15,61.4)(-10,69.2)(-5,77.8)(0,86.8)(5,90.1)(10,92.4)(15,92.9)};
\addplot[color=blue!80!black, densely dashed, mark=diamond*]
...
% Shared legend centered below all plots
\node[anchor=north] at ($(p4.south)!0.5!(p5.south) + (0,-0.3cm)$)
  {\ref{shared_legend}};
